...
import edu.socialnetwork.config.audit.AuditEventConverter;
import edu.socialnetwork.domain.PersistentAuditEvent;
...
import static edu.socialnetwork.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
