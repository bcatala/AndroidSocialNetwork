...
import { getEntities, reset } from './gender.reducer';
...
export type IGenderState = IPaginationBaseState;

export class Gender extends React.Component<IGenderProps, IGenderState> {
  state: IGenderState = {
  ...
  render() {
    const { genderList, match } = this.props;
    return (
      <div>
        <h2 id="gender-heading">
          <Translate contentKey="socialNetworkBackendApp.gender.home.title">Genders</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="socialNetworkBackendApp.gender.home.createLabel">Create new Gender</Translate>
          </Link>
        </h2>
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('type')}>
                    <Translate contentKey="socialNetworkBackendApp.gender.type">Type</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
