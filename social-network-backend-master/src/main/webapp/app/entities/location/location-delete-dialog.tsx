  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="socialNetworkBackendApp.location.delete.question">
          <Translate contentKey="socialNetworkBackendApp.location.delete.question" interpolate={{ id: locationEntity.id }}>
