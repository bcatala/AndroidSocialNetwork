    ...
    return (
      <div>
        <h2 id="location-heading">
          <Translate contentKey="socialNetworkBackendApp.location.home.title">Locations</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="socialNetworkBackendApp.location.home.createLabel">Create new Location</Translate>
          </Link>
        </h2>
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('latitude')}>
                    <Translate contentKey="socialNetworkBackendApp.location.latitude">Latitude</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('longitude')}>
                    <Translate contentKey="socialNetworkBackendApp.location.longitude">Longitude</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('urlGoogleMaps')}>
                    <Translate contentKey="socialNetworkBackendApp.location.urlGoogleMaps">Url Google Maps</Translate>{' '}
                    <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('urlOpenStreetMap')}>
                  ...
                  <th className="hand" onClick={this.sort('address')}>
                    <Translate contentKey="socialNetworkBackendApp.location.address">Address</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  ...
                  <th className="hand" onClick={this.sort('city')}>
                    <Translate contentKey="socialNetworkBackendApp.location.city">City</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('stateProvice')}>
                  ...
                  <th className="hand" onClick={this.sort('county')}>
                    <Translate contentKey="socialNetworkBackendApp.location.county">County</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('country')}>
                    <Translate contentKey="socialNetworkBackendApp.location.country">Country</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
              <tbody>
                {locationList.map((location, i) => (
                  <tr key={`entity-${i}`}>
                    ...
                    <td>{location.urlGoogleMaps}</td>
                    <td>{location.urlOpenStreetMap}</td>
                    <td>{location.address}</td>
                    <td>{location.postalCode}</td>
                    <td>{location.city}</td>
                    <td>{location.stateProvice}</td>
